...
int main(int argc, char *argv[])
{
    ...
    // Criação de imagens output
    {
        ...
        ofstream outFilex("./serial/out/outputx.ppm", ofstream::out);
        if (outFilex.is_open())
        {
            outFilex << img_streamx;
        }
        ofstream outFiley("./serial/out/outputy.ppm", ofstream::out);
        if (outFiley.is_open())
        {
            outFiley << img_streamy;
        }
        ofstream outFile("./serial/out/output.ppm", ofstream::out);
        if (outFile.is_open())
        {
            outFile << img_stream;
        }
        ofstream outFileGrey("./serial/out/outputGrey.pgm", ofstream::out);
    ...
    {
        FILE *fp;
        char outputFilename[] = "./serial/tempo_omp_filters.txt";
